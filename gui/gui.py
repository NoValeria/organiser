...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableView.setGeometry(QtCore.QRect(420, 20, 211, 451))
        self.tableView.setObjectName("tableView")
        self.DayTask = QtWidgets.QTableView(self.frame)
        self.DayTask.setGeometry(QtCore.QRect(160, 20, 256, 451))
        self.DayTask.setObjectName("DayTask")
